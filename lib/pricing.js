/**
 * Service catalogue and pricing, mirroring the published list on /pricing.
 * Shared by the booking form and the server so the options a customer sees and
 * the amount they are charged cannot disagree. "Custom Quote" services are
 * marked `quoteOnly` and priced by hand.
 */
...
/** Only the priced add-ons join the total; the rest are quoted separately. */
export const ADDONS = [
...
/**
 * Flat £50, capped at the booking value — charging more than the job was worth
 * would be a penalty rather than a genuine estimate of loss.
 */
