      ...
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <Image
              src="/cleaners/chinwike-godswill.jpg"
              alt="Chinwike Godswill"
              width={220}
              height={220}
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-10">
            ...
            <div className="border rounded-2xl p-6">
              ...
              <p><strong>Cleaner ID:</strong> NVG-CLN-004</p>
          ...
          <div className="mt-8 bg-teal-50 border border-teal-200 rounded-2xl p-6 text-center">
            ...
            <Image
              src="/qr/chinwike-godswill-qr.png"
